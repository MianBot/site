...
from .RuleMatcher import rulebase as rulebase
...
class Console(object):
    ...
    def __init__(self,model_path=path_root+"/model/ch-corpus-3sg.bin",
                 rule_path=path_root+"/RuleMatcher/rule/",
                 stopword=path_root+"/jieba_dict/stopword.txt",
                 jieba_dic=path_root+"/jieba_dict/dict.txt.big",
                 jieba_user_dic=path_root+"/jieba_dict/userdict.txt"):
    ...
    def listen(self):
        ...
        while True:
            ...
            if choice == 'e':
                ...
                self.rb.load_rules(path_root+'Chatbot/RuleMatcher/rule/',reload=True)
            elif choice == 'd':
                self.test_speech()
            elif choice == 'm':
    ...
    def test_speech(self):
        ...
        output = open(path_root+'Chatbot/example/output.txt','w',encoding='utf-8')
        # load sample data
        with open(path_root+'Chatbot/example/speech.txt','r',encoding='utf-8') as input:
            for speech in input:
                speech = speech.strip('\n')
