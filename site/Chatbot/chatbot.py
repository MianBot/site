...
from . import console
from .task_modules import module_switch as module_switch
...
class Chatbot(object):
    ...
    def __init__(self, name="NCKU"):
        ...
        path_root = os.path.dirname(__file__)#'/root/WebApp/'
        cur_dir = os.getcwd()
        os.chdir(os.path.dirname(__file__))
        self.extract_attr_log = open(path_root+'/log/extract_arrt.log','w',encoding='utf-8')
        os.chdir(cur_dir)

        self.console = console.Console(model_path=path_root+"/model/ch-corpus-3sg.bin")
